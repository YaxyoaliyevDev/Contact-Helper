package com.example.kotlinswipebuttonrcl.Helper
...
abstract class MySwipeHelper(val context: Context, private val recyclerView: RecyclerView, internal var buttonWidth:Int)
    ...
    private fun drawButton(c: Canvas, itemView: View, buffer: MutableList<MyButton>, pos: Int, translationX: Float) {
        ...
        for (button in buffer){
            ...
            button.onDraw(c, RectF(left, itemView.top.toFloat(), right-10, itemView.bottom.toFloat()), pos)
            right = left
        }
    }
}